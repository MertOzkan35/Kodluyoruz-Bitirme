            ...
            {this.props.allData &&
              this.props.allData.map((element, key) => {
                return (
                  ...
                  >
                    <Link key={key} to={`/admin/update/${element.Id}`}>
                    ...
                    <div className="w-full flex justify-center items-center pt-8">
                      <Link
                        to={`/admin/update/${element.Id}`}
                        className="w-1/2  h-12 flex items-center text-center justify-center bg-[#fa9d28]  hover:border-2 rounded-2xl border font-bold"
                      >
                        Ürünü Güncelle
                      </Link>
                    </div>
