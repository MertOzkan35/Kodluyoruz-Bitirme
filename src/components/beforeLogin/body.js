    ...
    <div className="flex flex-col">
      ...
      <div className=" border-b-2  flex flex-col-3 justify-center">
        ...
        >
          ...
          <p className="font-bold text-[#207609] text-center">{data[0].Stok}</p>
        ...
        >
          ...
          <p className="font-bold text-[#207609] text-center">{data[7].Stok}</p>
          <p className="text-black hover:text-[#fa9d28] text-center text-xl font-bold mt-8">
            {data[7].Name}
          </p>
          <p className="text-[#001d48] text-center text-xl font-bold mt-12">
        ...
        >
          ...
          <p className="font-bold  text-center text-red-800">{data[11].Stok}</p>
          <p className="text-black hover:text-[#fa9d28] text-center text-xl font-bold mt-8">
            {data[11].Name}
          </p>
          <p className="text-[#001d48] text-center text-xl font-bold mt-12">
